...
public class FileUpload implements Serializable {
    ...
    public static Map<String, String> imgUpload(File file, String fileName)
        ...
        // 获取文件上传的物理路径
//      imgPath = /app/upload/images
        String imgPath = PropertyManager.getProperty("imgPath");
        String originalPath = imgPath + "/original/";
        String bigPath = imgPath + "/big/";
        String thumbPath = imgPath + "/thumb/";

        String suffix = "";
        String current = DateUtils.formatCurrentDateTime("yyyyMMddHHmmss") + System.currentTimeMillis();
        ...
        // imagesServer=/upload/images
        String newName = current + "." + suffix;
        String imgUrl = PropertyManager.getProperty("imagesServer");
    ...
    public static Map<String, String> fileUpload(File file, String fileName)
            throws IOException {
        // 获取文件上传的物理路径
        String filePath = PropertyManager.getProperty("filePath");
        ...
        String newName = current + "." + suffix;
        String fileUrl = PropertyManager.getProperty("filesServer");
